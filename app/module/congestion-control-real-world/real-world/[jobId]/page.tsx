...
export default async function RealWorldDetailPage({ params }: { params: Promise<{ jobId: string }> }) {
  ...
  return <main className="mx-auto max-w-6xl px-4 py-8"><Link href={`${REAL_WORLD_MODULE_PATH}/real-world`} className="text-sm text-muted-foreground underline underline-offset-4">All real-world tests</Link>
