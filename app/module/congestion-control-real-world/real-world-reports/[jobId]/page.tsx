...
export default async function ReportPage({ params }: { params: Promise<{ jobId: string }> }) {
  ...
  return <main className="research-report-page mx-auto max-w-7xl px-4 py-8">
    <Link href={`${REAL_WORLD_MODULE_PATH}/real-world-reports`} className="text-sm text-muted-foreground underline underline-offset-4 print:hidden">All test results</Link>
