...
export const metadata: Metadata = { title: "Real-world research reports" };
export default async function ReportsPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <main className="research-report-page mx-auto max-w-7xl px-4 py-8">
    <h1 className="text-2xl font-semibold">Real-world research reports</h1>
    ...
    <Suspense fallback={<p className="mt-6 text-sm" role="status">Loading reports…</p>}><RealWorldReports /></Suspense>
  </main>;
}
