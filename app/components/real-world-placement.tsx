...
export function RealWorldPlacement({ label, value, regions, onChange }: {
  ...
  return <fieldset className="min-w-0 space-y-3 rounded-md border p-4">
    ...
    <div className="grid gap-4 md:grid-cols-3">
      <Choice label={`${label} Region`} value={value.region} items={regions.map((r) => ({ value: r.region,
        ...
        onChange={(region) => onChange({ region, zone_id: "", instance_type: "" })} />
